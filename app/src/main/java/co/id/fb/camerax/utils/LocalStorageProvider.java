...
import co.id.fb.camerax.R;

public class LocalStorageProvider extends DocumentsProvider {

    public static final String AUTHORITY = "com.surveyoi.localstorage.documents";
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, Objects.requireNonNull(getContext()).getString(R.string.app_name));
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_flashlight_on);
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e("LocalStorageProvider", "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.e("LocalStorageProvider", "Error writing thumbnail");
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e("LocalStorageProvider", "Error closing thumbnail");
                }
        }
